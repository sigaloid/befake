...
[https://befake.fly.dev/](https://befake.fly.dev/)
...
3. Interactive Map
   See where your friends are posting from on an interactive map.The map is interactive, so you can zoom in and out, and move around. You can also click on a marker to see the details of the post in a popup on the map! Once logged in see [https://befake.fly.dev/map](https://befake.fly.dev/map) to see the map. Note: The map is does not work well on mobile devices.
